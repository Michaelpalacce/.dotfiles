return {
	...
	{ 'j-hui/fidget.nvim', tag = 'legacy' }, -- Shows a spinner of lsp loading
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>dw", function() require("trouble").open("workspace_diagnostics") end, { desc = 'Trouble: [W]orkspace Diagnostics' })
			vim.keymap.set("n", "<leader>dd", function() require("trouble").open("document_diagnostics") end, { desc = 'Trouble: [D]ocument Diagnostics' })
			vim.keymap.set("n", "<leader>dq", function() require("trouble").open("quickfix") end, { desc = 'Trouble: [Q]uickfix' })
			vim.keymap.set("n", "<leader>dl", function() require("trouble").open("loclist") end, { desc = 'Trouble: [L]ocallist' })
