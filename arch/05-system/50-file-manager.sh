...
if [ "$MINIMAL" == false ]; then
    # File Manager
    yay --noconfirm -S nautilus nautilus-admin-gtk4 nautilus-image-converter nautilus-open-any-terminalunzip \
    ...
    # File Preview 
    yay --noconfirm -S ffmpegthumbnailer gst-libav gst-plugins-ugly
fi
