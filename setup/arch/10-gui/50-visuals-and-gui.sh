...
if [[ "$MINIMAL" == false ]]; then
    yay --noconfirm -S --needed catppuccin-gtk-theme-mocha nwg-look gtkmm3 qt6-svg qt6-declarative qt5-quickcontrols2 waycorner brightnessctl light
    ...
    # Wallpaper
    yay --noconfirm -S --needed waypaper swww mpvpaper
fi